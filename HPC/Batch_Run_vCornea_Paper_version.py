...
sim_version_path = base_path / 'HPC/Project/paper_version'
output_version_path = base_path / 'Simulations_Output'
run_name = 'Injury_Chem_at500mcs_to_32day_recov_sl750_mi1500_mo2500'
...
#---SLS AREA---
    'SLS_X_Center'              : [100],
    'SLS_Y_Center'              : [65],
    'SLS_Concentration'         : [750.0, 1500.0, 2500.0], # [slight, mild,  moderate]
...
# xvfb-run -a 
srun {base_path}.conda/envs/cc3d_46/bin/cc3d_runScript.sh -i {cc3d_file} -f {VTK_frames} &
