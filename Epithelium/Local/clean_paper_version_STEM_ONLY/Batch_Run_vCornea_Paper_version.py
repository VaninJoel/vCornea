...
base_path = '/geode2/home/u040/jvanin/BigRed200/'
sim_version_path = '/geode2/home/u040/jvanin/BigRed200/vCornea/Epithelium/HPC/Project/paper_version'
output_version_path = '/N/scratch/jvanin/vCornea/Simulations_Output'
run_name = 'TEST139_CHEMICAL_Injury_Gau_Uni_1month_6months'
...
HOURtoMCS   = 10
DAYtoMCS    = 240
WEEKtoMCS   = 1680  #7 days
MONTHtoMCS  = 7200  #30 days
YEARtoMCS   = 87600 #365 days
...
# WOUND
    'InjuryType'                : [False],  # False =Chemical 
    'IsInjury'                  : [True],  # Control false
    'InjuryTime'                : [7200],
    'SLS_Injury'                : [True], 
...
#---SLS AREA---
    'SLS_X_Center'              : [100],
    'SLS_Y_Center'              : [75],
    'SLS_Concentration'         : [750.0, 1000.0, 1500.0, 2000.0, 2500.0], #[750.0, 1000.0, 1500.0, 2000.0, 2500.0],
    'SLS_Gaussian_pulse'        : [True, False],
#Links
...
#   PLOTS
    ...
    # 'MitosisPlot'               : [False],   
    # 'SingleCellPresEGFPlot'     : [False],
    # 'MassConservationPlot'      : [False],
...
def generate_sbatch_string(cc3d_file, node=1, job_name='vCornea', out_file='simulation_out_BIGRED',
...
VALGRIND_LOG="valgrind_log_${{SLURM_JOBID}}.txt"
