...
base_path = '/u/jvanin/'
sim_version_path = '/u/jvanin/vCornea/Epithelium/HPC/Project/vCornea_v_PaperHPC_version_6'
output_version_path = '/u/jvanin/vCornea/Output/Output_Version_6'
run_name = '2k_image_gen'

csv_file_param = '/u/jvanin/vCornea/Processed_Data/Output_Version_6/9000/Filtered/varying_parameters_data.csv' #None  #TODO Provide file with LHS if desired or None
...
#---STEM---
    ...
    'DensitySTEM_HalfMaxValue'  : [100.,], #[50., 75., 100., 125., 150., 200.],   
    'EGF_STEM_HalfMaxValue'     : [4.,], #[1.,2.,3.,4.,5.,6.,7.,8.], 
...
#---BASAL---
    ...
    'DensityBASAL_HalfMaxValue' : [100.,], #[50., 75., 100., 125., 150., 200.], 
    'EGF_BASAL_HalfMaxValue'    : [6.,], #[1.,2.,3.,4.,5.,6.,7.,8.], 
    'BASAL_beta_EGF'            : [1.0],  
# Growth Scalars 
...
#---SUPERFICIAL---
    ...
    'EGF_SUPERDiffCoef'         : [2.,], #[1.,2.,5.], # 1/2048 barrier | 1/1024 barrier | 1/512 barrier  !!
